...
(def lib 'com.sturdystats/agentti)
...
(defn jar
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    :src-dirs  ["src"]
    :pom-data
    [[:description "Minimal background workers for Clojure services."]
     [:url "https://github.com/Sturdy-Statistics/agentti"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/agentti"]
      [:connection "scm:git:https://github.com/Sturdy-Statistics/agentti.git"]]]})
